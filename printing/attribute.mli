...
module Payload : sig(* To be filled in to close the recursion! *)
  ...
  val pp_sig : (signature_item -> signature_item list -> Document.t) ref
  val sig_ends_in_obj : (signature_item list -> bool) ref
  val pp_core_type : (core_type -> Document.t) ref
  val ct_ends_in_obj : (core_type -> bool) ref
